 ...
 */
 public class AntLabMain {
	...
	Person1 p1 = new Person1("Dale Rivera");
	toPrint += p1.toString("drivera8");
	//Person2 replace P2 with your name
	//and gburdell with your gt id
	Person2 p2 = new Person2("Sai Naga Manoj Paladugu");
	toPrint += p2.toString("spaladugu3");
	//Person3 replace P3 with your name
	//and gburdell3 with your gt id
	Person3 p3 = new Person3("Jennifer Hwang");
	toPrint += p3.toString("jhwang39");
	//Person4 replace P4 with your name
	//and gburdell4 with your gt id
	Person4 p4 = new Person4("Julia Ting");
	toPrint += p4.toString("jting8");
	//Person5 replace P4 with your name
	//and gburdell5 with your gt id
	Person5 p5 = new Person5("Farhan Khan");
	toPrint += p5.toString("fkhan35");
	//Person6 replace P6 with your name
	//and gburdell6 with your gt id
	Person6 p6 = new Person6("John Crawford");
	toPrint += p6.toString("jcrawford42");
